  ...
  <div class="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-3xl space-y-6">
      ...
      <nav
        ...
        class="rounded-3xl border-4 border-gray-900 p-6 dark:border-gray-700"
      >
        <ul class="flex flex-wrap justify-center gap-6 text-sm font-bold">
          <li>
            <Link
              class="text-gray-900 transition hover:text-gray-900/75 dark:text-white dark:hover:text-white/75"
              to="/"
